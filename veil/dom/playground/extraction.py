...
from veil.browser.events import ClickElementEvent, TypeTextEvent
from veil.browser.profile import ViewportSize
from veil.dom.service import DomService
from veil.dom.views import DEFAULT_INCLUDE_ATTRIBUTES
...
async def test_focus_vs_all_elements():
	...
	sample_websites = [
		'https://veil.github.io/stress-tests/challenges/iframe-inception-level2.html',
		'https://www.google.com/travel/flights',
		'https://v0-simple-ui-test-site.vercel.app',
		'https://veil.github.io/stress-tests/challenges/iframe-inception-level1.html',
		'https://veil.github.io/stress-tests/challenges/angular-form.html',
		'https://www.google.com/travel/flights',
