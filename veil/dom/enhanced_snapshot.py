"""
Enhanced snapshot processing for veil DOM tree extraction.
...
from veil.dom.views import DOMRect, EnhancedSnapshotNode
...
def build_snapshot_lookup(
	...
	logger = logging.getLogger('veil.dom.enhanced_snapshot')
