"""Configuration system for veil with automatic migration support."""
...
class OldConfig:
	...
	def BROWSER_USE_CLOUD_API_URL(self) -> str:
		url = os.getenv('BROWSER_USE_CLOUD_API_URL', 'https://api.veil.com')
...
class FlatEnvConfig(BaseSettings):
	...
	BROWSER_USE_CLOUD_API_URL: str = Field(default='https://api.veil.com')
...
def load_veil_config() -> dict[str, Any]:
	"""Load veil configuration for MCP components."""
