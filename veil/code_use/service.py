...
from veil.browser import BrowserSession
from veil.browser.profile import BrowserProfile
...
from veil.tokens.views import UsageSummary
from veil.tools.service import CodeAgentTools, Tools
...
class CodeAgent:
	...
	def __init__(
		...
		**kwargs,
		...
		self.agent_directory = base_tmp / f'veil_code_agent_{self.id}_{timestamp}'
