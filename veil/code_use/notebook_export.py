...
from veil import BrowserSession
from veil.code_use import create_namespace
...
def session_to_python_script(agent: CodeAgent) -> str:
	...
	lines.append('# Generated from veil code-use session\n')
	lines.append('import asyncio\n')
	lines.append('import json\n')
	lines.append('from veil import BrowserSession\n')
	lines.append('from veil.code_use import create_namespace\n\n')
